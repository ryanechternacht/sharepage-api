...
(defn- reformat-author [{:keys [author_first_name author_last_name author_display_role] :as conversation}]
  (-> conversation
      (dissoc :author_first_name :author_last_name :author_display_role)
      (assoc :author {:first_name author_first_name
                      :last_name author_last_name
                      :display_role author_display_role})))

(defn- reformat-assigned-to [{:keys [assigned_to_first_name assigned_to_last_name assigned_to_display_role] :as conversation}]
  (-> conversation
      (dissoc :assigned_to_first_name :assigned_to_last_name :assigned_to_display_role)
      (assoc :assigned_to {:first_name assigned_to_first_name
